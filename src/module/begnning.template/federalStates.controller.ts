...
import { TrainingService } from "./federalStates.service";
import logger from "../../utils/logger";

class BeginningController {
  private readonly federalStateService: TrainingService;

  constructor() {
    this.federalStateService = new TrainingService();
  }
...
export default BeginningController;
