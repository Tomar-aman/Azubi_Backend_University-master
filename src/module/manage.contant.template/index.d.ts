export interface AboutContentOperationField {
  banner: string;
  textBlock: string;
  aboutFeature: string;
  marketing: string;
...
export interface JobMagazineContentOperationField {
  header: string;
...
export interface ContactUsOperationField {
  pageHeading: string;
...
export interface JobWallOperationField {
  banner: string;
...
export interface EmailContentOperationField {
  appointment: string;
  application: string;
}
