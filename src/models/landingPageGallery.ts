...
const LandingPageImagesSchema = new Schema<ManageHomePageDocument>(
  {
    images: [
...
const LandingPageImagesModel = model<ManageHomePageDocument>(
  "LandingPageImages",
  LandingPageImagesSchema
);

export default LandingPageImagesModel;
